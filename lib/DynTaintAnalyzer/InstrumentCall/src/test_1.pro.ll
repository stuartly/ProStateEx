; ModuleID = '/home/lzs243/Documents/ProtocolEx/lib/DynTaintAnalyzer/InstrumentCall/src/test_1.pro.bc'
...
entry:
  ...
  call void @printTaint(i32 0)
  %b = alloca i32, align 4, !bb_id !11, !ins_id !12
  call void @printTaint(i32 1)
  call void @PropagateTaintRegToReg(i32 0, i32 2)
  store i32 %a, i32* %a.addr, align 4, !bb_id !11, !ins_id !13
  call void @printTaint(i32 2)
  call void @llvm.dbg.declare(metadata i32* %a.addr, metadata !14, metadata !15), !dbg !16, !bb_id !11, !ins_id !17
  call void @printTaint(i32 3)
  call void @llvm.dbg.declare(metadata i32* %b, metadata !18, metadata !15), !dbg !19, !bb_id !11, !ins_id !20
  call void @printTaint(i32 4)
  call void @PropagateTaintRegToReg(i32 0, i32 5)
  %0 = load i32, i32* %a.addr, align 4, !dbg !21, !bb_id !11, !ins_id !22
  call void @printTaint(i32 5)
  call void @PropagateTaintRegToReg(i32 5, i32 6)
  call void @RemoveTaint(i32 6)
  %add = add nsw i32 %0, 3, !dbg !23, !bb_id !11, !ins_id !24
  call void @printTaint(i32 6)
  call void @PropagateTaintRegToReg(i32 6, i32 1)
  call void @PropagateTaintRegToReg(i32 1, i32 7)
  store i32 %add, i32* %b, align 4, !dbg !19, !bb_id !11, !ins_id !25
  call void @printTaint(i32 7)
  call void @PropagateTaintRegToReg(i32 1, i32 8)
  %1 = load i32, i32* %b, align 4, !dbg !26, !bb_id !11, !ins_id !27
  call void @printTaint(i32 8)
  call void @PropagateTaintRegToReg(i32 8, i32 9)
  call void @printTaint(i32 9)
...
entry:
  ...
  call void @printTaint(i32 10)
  %input = alloca i32, align 4, !bb_id !12, !ins_id !34
  call void @printTaint(i32 11)
  %a = alloca i32, align 4, !bb_id !12, !ins_id !35
  call void @printTaint(i32 12)
  %second = alloca i32, align 4, !bb_id !12, !ins_id !36
  call void @printTaint(i32 13)
  %T3 = alloca i32*, align 8, !bb_id !12, !ins_id !37
  call void @printTaint(i32 14)
  %third = alloca i32, align 4, !bb_id !12, !ins_id !38
  call void @printTaint(i32 15)
  %four = alloca i32, align 4, !bb_id !12, !ins_id !39
  call void @printTaint(i32 16)
  %five = alloca i32, align 4, !bb_id !12, !ins_id !40
  call void @printTaint(i32 17)
  %T6 = alloca i32, align 4, !bb_id !12, !ins_id !41
  call void @printTaint(i32 18)
  %T7 = alloca i32, align 4, !bb_id !12, !ins_id !42
  call void @printTaint(i32 19)
  %T8 = alloca i32, align 4, !bb_id !12, !ins_id !43
  call void @printTaint(i32 20)
  call void @RemoveTaint(i32 10)
  call void @PropagateTaintRegToReg(i32 10, i32 21)
  store i32 0, i32* %retval, align 4, !bb_id !12, !ins_id !44
  call void @printTaint(i32 21)
  call void @llvm.dbg.declare(metadata i32* %input, metadata !45, metadata !15), !dbg !46, !bb_id !12, !ins_id !47
  call void @printTaint(i32 22)
  call void @MarkTaint(i32 11)
  %call = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i32 0, i32 0), i32* %input), !dbg !48, !bb_id !12, !ins_id !49
  call void @printTaint(i32 23)
  call void @llvm.dbg.declare(metadata i32* %a, metadata !50, metadata !15), !dbg !51, !bb_id !12, !ins_id !52
  call void @printTaint(i32 24)
  call void @RemoveTaint(i32 12)
  call void @PropagateTaintRegToReg(i32 12, i32 25)
  store i32 3, i32* %a, align 4, !dbg !51, !bb_id !12, !ins_id !53
  call void @printTaint(i32 25)
  call void @llvm.dbg.declare(metadata i32* %second, metadata !54, metadata !15), !dbg !55, !bb_id !12, !ins_id !56
  call void @printTaint(i32 26)
  call void @PropagateTaintRegToReg(i32 11, i32 27)
  %0 = load i32, i32* %input, align 4, !dbg !57, !bb_id !12, !ins_id !58
  call void @printTaint(i32 27)
  call void @PropagateTaintRegToReg(i32 27, i32 28)
  call void @RemoveTaint(i32 28)
  %add = add nsw i32 %0, 2, !dbg !59, !bb_id !12, !ins_id !60
  call void @printTaint(i32 28)
  call void @PropagateTaintRegToReg(i32 28, i32 13)
  call void @PropagateTaintRegToReg(i32 13, i32 29)
  store i32 %add, i32* %second, align 4, !dbg !55, !bb_id !12, !ins_id !61
  call void @printTaint(i32 29)
  call void @llvm.dbg.declare(metadata i32** %T3, metadata !62, metadata !15), !dbg !64, !bb_id !12, !ins_id !65
  call void @printTaint(i32 30)
  call void @PropagateTaintRegToReg(i32 11, i32 14)
  call void @PropagateTaintRegToReg(i32 14, i32 31)
  store i32* %input, i32** %T3, align 8, !dbg !64, !bb_id !12, !ins_id !66
  call void @printTaint(i32 31)
  call void @llvm.dbg.declare(metadata i32* %third, metadata !67, metadata !15), !dbg !68, !bb_id !12, !ins_id !69
  call void @printTaint(i32 32)
  call void @PropagateTaintRegToReg(i32 13, i32 33)
  %1 = load i32, i32* %second, align 4, !dbg !70, !bb_id !12, !ins_id !71
  call void @printTaint(i32 33)
  call void @PropagateTaintRegToReg(i32 12, i32 34)
  %2 = load i32, i32* %a, align 4, !dbg !72, !bb_id !12, !ins_id !73
  call void @printTaint(i32 34)
  call void @PropagateTaintRegToReg(i32 33, i32 35)
  call void @PropagateTaintRegToReg(i32 34, i32 35)
  %add1 = add nsw i32 %1, %2, !dbg !74, !bb_id !12, !ins_id !75
  call void @printTaint(i32 35)
  call void @PropagateTaintRegToReg(i32 35, i32 15)
  call void @PropagateTaintRegToReg(i32 15, i32 36)
  store i32 %add1, i32* %third, align 4, !dbg !68, !bb_id !12, !ins_id !76
  call void @printTaint(i32 36)
  call void @llvm.dbg.declare(metadata i32* %four, metadata !77, metadata !15), !dbg !78, !bb_id !12, !ins_id !79
  call void @printTaint(i32 37)
  call void @PropagateTaintRegToReg(i32 15, i32 38)
  %3 = load i32, i32* %third, align 4, !dbg !80, !bb_id !12, !ins_id !81
  call void @printTaint(i32 38)
  call void @PropagateTaintRegToReg(i32 38, i32 39)
  call void @RemoveTaint(i32 39)
  %mul = mul nsw i32 %3, 4, !dbg !82, !bb_id !12, !ins_id !83
  call void @printTaint(i32 39)
  call void @PropagateTaintRegToReg(i32 39, i32 16)
  call void @PropagateTaintRegToReg(i32 16, i32 40)
  store i32 %mul, i32* %four, align 4, !dbg !78, !bb_id !12, !ins_id !84
  call void @printTaint(i32 40)
  call void @llvm.dbg.declare(metadata i32* %five, metadata !85, metadata !15), !dbg !86, !bb_id !12, !ins_id !87
  call void @printTaint(i32 41)
  call void @PropagateTaintRegToReg(i32 16, i32 42)
  %4 = load i32, i32* %four, align 4, !dbg !88, !bb_id !12, !ins_id !89
  call void @printTaint(i32 42)
  call void @PropagateTaintRegToReg(i32 42, i32 0)
  %call2 = call i32 @_Z3fooi(i32 %4), !dbg !90, !bb_id !12, !ins_id !91
  call void @PropagateTaintRegToReg(i32 9, i32 43)
  call void @printTaint(i32 43)
  call void @PropagateTaintRegToReg(i32 43, i32 17)
  call void @PropagateTaintRegToReg(i32 17, i32 44)
  store i32 %call2, i32* %five, align 4, !dbg !86, !bb_id !12, !ins_id !92
  call void @printTaint(i32 44)
  call void @PropagateTaintRegToReg(i32 13, i32 45)
  %5 = load i32, i32* %second, align 4, !dbg !93, !bb_id !12, !ins_id !95
  call void @printTaint(i32 45)
  call void @PropagateTaintRegToReg(i32 45, i32 46)
  call void @RemoveTaint(i32 46)
  %cmp = icmp sgt i32 %5, 5, !dbg !96, !bb_id !12, !ins_id !97
  call void @printTaint(i32 46)
  call void @printTaint(i32 47)
  br i1 %cmp, label %if.then, label %if.end, !dbg !98, !bb_id !12, !ins_id !99

if.then:                                          ; preds = %entry
  call void @RemoveTaint(i32 12)
  call void @PropagateTaintRegToReg(i32 12, i32 48)
  store i32 6, i32* %a, align 4, !dbg !100, !bb_id !13, !ins_id !102
  call void @printTaint(i32 48)
  call void @printTaint(i32 49)
...
if.end:                                           ; preds = %if.then, %entry
  ...
  call void @printTaint(i32 50)
  call void @PropagateTaintRegToReg(i32 12, i32 51)
  %6 = load i32, i32* %a, align 4, !dbg !108, !bb_id !17, !ins_id !109
  call void @printTaint(i32 51)
  call void @PropagateTaintRegToReg(i32 51, i32 18)
  call void @PropagateTaintRegToReg(i32 18, i32 52)
  store i32 %6, i32* %T6, align 4, !dbg !106, !bb_id !17, !ins_id !110
  call void @printTaint(i32 52)
  call void @llvm.dbg.declare(metadata i32* %T7, metadata !111, metadata !15), !dbg !112, !bb_id !17, !ins_id !113
  call void @printTaint(i32 53)
  call void @PropagateTaintRegToReg(i32 12, i32 54)
  %7 = load i32, i32* %a, align 4, !dbg !114, !bb_id !17, !ins_id !115
  call void @printTaint(i32 54)
  call void @PropagateTaintRegToReg(i32 54, i32 55)
  call void @RemoveTaint(i32 55)
  %tobool = icmp ne i32 %7, 0, !dbg !114, !bb_id !17, !ins_id !116
  call void @printTaint(i32 55)
  call void @printTaint(i32 56)
  br i1 %tobool, label %lor.end, label %lor.lhs.false, !dbg !117, !bb_id !17, !ins_id !118

lor.lhs.false:                                    ; preds = %if.end
  call void @PropagateTaintRegToReg(i32 13, i32 57)
  %8 = load i32, i32* %second, align 4, !dbg !119, !bb_id !20, !ins_id !120
  call void @printTaint(i32 57)
  call void @PropagateTaintRegToReg(i32 57, i32 58)
  call void @RemoveTaint(i32 58)
  %tobool3 = icmp ne i32 %8, 0, !dbg !119, !bb_id !20, !ins_id !121
  call void @printTaint(i32 58)
  call void @printTaint(i32 59)
  br i1 %tobool3, label %lor.end, label %lor.lhs.false4, !dbg !122, !bb_id !20, !ins_id !123

lor.lhs.false4:                                   ; preds = %lor.lhs.false
  call void @PropagateTaintRegToReg(i32 16, i32 60)
  %9 = load i32, i32* %four, align 4, !dbg !124, !bb_id !22, !ins_id !125
  call void @printTaint(i32 60)
  call void @PropagateTaintRegToReg(i32 60, i32 61)
  call void @RemoveTaint(i32 61)
  %tobool5 = icmp ne i32 %9, 0, !dbg !124, !bb_id !22, !ins_id !126
  call void @printTaint(i32 61)
  call void @printTaint(i32 62)
  br i1 %tobool5, label %lor.end, label %lor.rhs, !dbg !127, !bb_id !22, !ins_id !128

lor.rhs:                                          ; preds = %lor.lhs.false4
  call void @PropagateTaintRegToReg(i32 17, i32 63)
  %10 = load i32, i32* %five, align 4, !dbg !129, !bb_id !24, !ins_id !130
  call void @printTaint(i32 63)
  call void @PropagateTaintRegToReg(i32 63, i32 64)
  call void @RemoveTaint(i32 64)
  %tobool6 = icmp ne i32 %10, 0, !dbg !129, !bb_id !24, !ins_id !131
  call void @printTaint(i32 64)
  call void @printTaint(i32 65)
...
lor.end:                                          ; preds = %lor.rhs, %lor.lhs.false4, %lor.lhs.false, %if.end
  ...
  call void @PropagateTaintRegToReg(i32 64, i32 66)
  call void @RemoveTaint(i32 66)
  call void @RemoveTaint(i32 66)
  call void @RemoveTaint(i32 66)
  call void @printTaint(i32 66)
  call void @PropagateTaintRegToReg(i32 66, i32 67)
  %conv = zext i1 %11 to i32, !dbg !114, !bb_id !25, !ins_id !134
  call void @printTaint(i32 67)
  call void @PropagateTaintRegToReg(i32 67, i32 19)
  call void @PropagateTaintRegToReg(i32 19, i32 68)
  store i32 %conv, i32* %T7, align 4, !dbg !112, !bb_id !25, !ins_id !135
  call void @printTaint(i32 68)
  call void @llvm.dbg.declare(metadata i32* %T8, metadata !136, metadata !15), !dbg !137, !bb_id !25, !ins_id !138
  call void @printTaint(i32 69)
  call void @PropagateTaintRegToReg(i32 12, i32 70)
  %12 = load i32, i32* %a, align 4, !dbg !139, !bb_id !25, !ins_id !140
  call void @printTaint(i32 70)
  call void @PropagateTaintRegToReg(i32 70, i32 71)
  call void @RemoveTaint(i32 71)
  %tobool7 = icmp ne i32 %12, 0, !dbg !139, !bb_id !25, !ins_id !141
  call void @printTaint(i32 71)
  call void @printTaint(i32 72)
  br i1 %tobool7, label %land.rhs, label %land.end, !dbg !142, !bb_id !25, !ins_id !143

land.rhs:                                         ; preds = %lor.end
  call void @PropagateTaintRegToReg(i32 13, i32 73)
  %13 = load i32, i32* %second, align 4, !dbg !144, !bb_id !27, !ins_id !145
  call void @printTaint(i32 73)
  call void @PropagateTaintRegToReg(i32 73, i32 74)
  call void @RemoveTaint(i32 74)
  %tobool8 = icmp ne i32 %13, 0, !dbg !144, !bb_id !27, !ins_id !146
  call void @printTaint(i32 74)
  call void @printTaint(i32 75)
...
land.end:                                         ; preds = %land.rhs, %lor.end
  ...
  call void @PropagateTaintRegToReg(i32 74, i32 76)
  call void @RemoveTaint(i32 76)
  call void @printTaint(i32 76)
  call void @PropagateTaintRegToReg(i32 76, i32 77)
  %conv9 = zext i1 %14 to i32, !dbg !139, !bb_id !29, !ins_id !149
  call void @printTaint(i32 77)
  call void @PropagateTaintRegToReg(i32 77, i32 20)
  call void @PropagateTaintRegToReg(i32 20, i32 78)
  store i32 %conv9, i32* %T8, align 4, !dbg !137, !bb_id !29, !ins_id !150
  call void @printTaint(i32 78)
  call void @PropagateTaintRegToReg(i32 16, i32 79)
  %15 = load i32, i32* %four, align 4, !dbg !151, !bb_id !29, !ins_id !152
  call void @printTaint(i32 79)
  %call10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0), i32 %15), !dbg !153, !bb_id !29, !ins_id !154
  call void @printTaint(i32 80)
  call void @RemoveTaint(i32 81)
  call void @printTaint(i32 81)
