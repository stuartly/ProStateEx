; ModuleID = '/home/lzs243/Documents/ProtocolEx/lib/DynTaintAnalyzer/InstrumentCall/src/test_1.id.io.loop.taint.bc'
...
@return_taint.1 = global i1 false
@return_taint.2 = global i1 false
...
entry:
  %param_taint_load = load i1, i1* @param_taint
...
entry:
  ...
  %retT_load = load i1, i1* @return_taint.1
  ...
  %retT_load1 = load i1, i1* @return_taint
